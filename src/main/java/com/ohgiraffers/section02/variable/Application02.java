...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        *   3. 변수를 사용한다
        * */
        //초기화는 삭제가 아니라 초기 값을 설정 해준다는 것,즉 setting

        /* 목차. 1. 변수를 준비한다. (선언)*/
        /* 목차.1-1. 변수를 선언하는 방법 */
        /* 필기. 자료형 변수명; */        //int point;

        /*필기.
        *   자료형이란?
        *   다양한 값을 형태별로 어느 정도의 크기를 하나의 값으로 취급할 것인지 미리 Compiler 와 약속한 키워드 이다.
        ...
        * */        //String 빼고 나머지가 기본 자료형
        ...
        ch= 'a';
        ch2 = 97;       //'a'는 97은 숫자였지? 그래서 숫자로도 저장할 수 있다.
