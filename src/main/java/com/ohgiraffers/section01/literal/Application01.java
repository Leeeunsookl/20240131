...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /*목차. 2. 문자 형태의 값 출력 */
        System.out.println('a');        //문자 형태의 값은 홀따옴표(single-qoutation)으로 감싸주어야 한다.
...
//        System.out.println('');       //아무 문자도 기록되지 않는 경우도 에러가 발생한다.
        ...
        /*목차. 3.문자열 형태의 값 출력 */
        System.out.println("안녕하세요 이은숙 입니다.");     //문자열은 문자 여러개가 나열된 형태를 말하며 쌍따옴표(double-qoutation)으로 감싸주어야 한다.
        ...
        System.out.println(false);      //true 혹은 false값을 논리형이라고 한다.
